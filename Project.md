...
12.0 – **Tools** <br>
 ...
 1.0 **Introduction** :<br>
  ...
  The Main gameplay loop requires the player to advance through a selection of **progressively harder levels** and defeated a boss at the end of  each. The levels will contain **pickups** to act as modifier to mix up the gameplay experience as well as health pickups etc.<br>
